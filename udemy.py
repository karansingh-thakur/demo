...
### INFO to Edit ###
email_account = "karansinght116@gmail.com" # Udemy's login
pwd_account = "Karan@8599" # Udemy's password
...
br.select_form(nr=3)
br["email"] = email_account
br["password"] = pwd_account
logged_in = br.submit() # Submit the form
